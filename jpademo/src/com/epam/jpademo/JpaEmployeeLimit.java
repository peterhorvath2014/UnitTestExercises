...
public class JpaEmployeeLimit {

	private static final int SALARY_LIMIT = 1000;
	private EntityManagerFactory emf;
	private EntityManager em;

	public JpaEmployeeLimit() {
		emf = Persistence
	...
	private void run() {
		/*TypedQuery<Employee> query = 
				em.createQuery("SELECT e FROM Employee e WHERE e.position.monthlySalary > :limit", Employee.class);
		query.setParameter("limit", SALARY_LIMIT);
